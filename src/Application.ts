...
const Diamond = require('./Diamond.wav');
const Font = require('./Font.gif');
const Sprite = require('./Sprite.gif');
const Step = require('url-loader?limit=10000!./Step.wav');
const Stone = require('url-loader?limit=10000!./Stone.wav');
...
export class Application
{
    ...
    constructor(canvas: HTMLCanvasElement)
    {
        ...
        this._soundPlayer.load("diamond", Diamond.split(',')[1]);
        this._soundPlayer.load("stone", Stone.split(',')[1]);
        this._soundPlayer.load("step", Step.split(',')[1]);

        this.loadImage(Font.split(',')[1], (fontImage) => {
            this._fontImage = fontImage;
            this.loadImage(Sprite.split(',')[1], (spriteImage) => {
...
new Application(<HTMLCanvasElement> document.getElementById('canvas'));
